            ...
            <div data-aos="fade-right" data-aos-duration="800">
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start" data-aos="fade-up" data-aos-delay="400">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Sunday: Appointment Only</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8" data-aos="fade-up" data-aos-delay="500">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://instagram.com/@havens_skincare_44" target="_blank" rel="noopener noreferrer" className="bg-seafoam text-white w-10 h-10 flex items-center justify-center rounded-full hover:bg-opacity-90 transition duration-300">
